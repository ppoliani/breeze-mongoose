...
var MODEL_NAMESPACE = 'models.itPrints3d',
...
var
     ...
     */
    getMetadata = function getMetadata(dbModels){
     ...
     * @private
     */
    _createStructuralType = function _createStructuralType(models){
     ...
     * @private
     */
    _parseEntitySchema = function _parseProperties(modelName, properties, structuralType){
     ...
     * @private
     */
    _isComplexType = function _isComplexType(property){
     ...
     * @private
     */
    _toPascalCase = function _toPascalCase(propertyName){
     ...
     * @private
     */
    _getFullPropertyName = function _getFullPropertyName(propName){
     ...
     * @private
     */
    _getDataProperty = function _addDataProperty(property, propertyName){
     ...
     * @private
     */
    _isForeignKey = function _isForeignKey(property){
        return property.name === 'ObjectId'
     ...
     * @private
     */
    _getForeignKeyInfo = function _getForeignKeyInfo(property, modelName, foreignKeyName){
     ...
     * @private
     */
    _getDataType = function _getDataType(prop) {
        var mongooseType = prop.type || prop;

        if(mongooseType instanceof Array){
            mongooseType = prop.type[0];
        }
...
exports.namespace = MODEL_NAMESPACE;
